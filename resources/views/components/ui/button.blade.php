...
@php
    ...
    $classes = match ($variant) {
        'primary' => "{$base} rounded-lg bg-slate-900 text-white hover:bg-slate-800 focus:outline-none focus:ring-2 focus:ring-slate-300 focus:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-60",
        ...
        default => "{$base} rounded-lg bg-slate-900 text-white",
    };
@endphp
