    ...
    <x-ui.page-card>
        <x-slot:toolbar>
            <div class="ui-toolbar-form">
                ...
                <x-ui.select id="products-category-filter" class="!w-auto min-w-40">
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const table = initAsyncTable({
        ...
        getParams: () => ({
            ...
            category_id: document.getElementById('products-category-filter')?.value ?? '',
        }),
        ...
        renderRows: (rows) => rows.map((product) => `
            <tr>
                ...
                <td>${escapeHtml(product.variant_count)}</td>
                <td>
    ...
    document.getElementById('products-category-filter')?.addEventListener('change', () => table.loadData(1));
