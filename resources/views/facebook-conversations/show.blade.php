...
<div class="flex h-full min-h-0 flex-col gap-4 overflow-hidden" data-messenger-inbox data-app-timezone="{{ config('app.timezone') }}">
    ...
    <div class="flex min-h-0 flex-1 overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm" style="height: 100vh; max-height: 100vh;">
        <div class="grid h-full min-h-0 flex-1 grid-cols-1 lg:grid-cols-[21rem_minmax(0,1fr)_19rem] lg:items-stretch" style="height: 100%; min-height: 0;">
            ...
            <section class="flex h-[100vh] max-h-[100vh] min-h-0 min-w-0 flex-col overflow-hidden border-b border-gray-200 lg:border-b-0 lg:border-r" style="height: 100vh; max-height: 100vh;">
